...
class _$_Tenant implements _Tenant {
  ...
  @override
  String toString() {
    return 'Tenant(active: $active, id: $id, email: $email, name: $name, occupation: $occupation, phoneNumber: $phoneNumber)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, active, id, email, name, occupation, phoneNumber);
...
abstract class _Tenant implements Tenant {
  const factory _Tenant(
      ...
      final String? name,
      final String? occupation,
      final String? phoneNumber}) = _$_Tenant;
